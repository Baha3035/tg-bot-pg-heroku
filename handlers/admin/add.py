...
async def set_category_title_handler(message: Message, state: FSMContext):
    ...
    db.query('INSERT INTO categories (title) VALUES (%s)', (category,))
...
async def process_confirm(message: Message, state: FSMContext):
    ...
    async with state.proxy() as data:
        ...
        db.query('INSERT INTO products (title, body, photo, price, tag) VALUES (%s, %s, %s, %s, %s)',
                 (title, body, image, int(price), tag))
